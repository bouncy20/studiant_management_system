...
def ADD_COURSE(request):
    ...
    if request.method == "POST":
      ...
      #  engine.runAndWait()
      #  engine.endLoop()
        return redirect('view_course') #add_course
...
def ADD_STAFF(request):
    if request.method == "POST":
        ...
        if CustomUser.objects.filter(username=username).exists():
            ...
            staff.save()
            messages.success(request,'Staff Are Successfullu Added !')
            return redirect('add_staff')
...
def UPDATE_SUBJECT(request):
    if request.method == "POST":
        ...
        subject.save()
        messages.success(request,'Subject Are Successfuly Update !')
...
def SAVE_STAFF_NOTIFICATION(request):
    if request.method == "POST":
        ...
        notification.save()
        messages.success(request,'Notification Are Successfuly Sent')
...
def SAVE_STUDENT_NOTIFICATION(request):
    if request.method == "POST":
        ...
        messages.success(request,'Student Notification Are Successfuly Sent')
